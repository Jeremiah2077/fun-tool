...
class SignalAmplifier:
    ...
    def enhance_signal(self,
        ...
        NOTE: This is designed for Mode 2 (oscillation) which starts from neutral position.
              Mode 1 (yolo_roi) does NOT use this - it uses adaptive scaling directly.

        Args:
            raw_primary: Raw primary axis position (0-100) - IGNORED for oscillation mode
            raw_secondary: Raw secondary axis position (0-100) - IGNORED for oscillation mode
        ...
        try:
            ...
            # This is correct for oscillation mode which starts from neutral
